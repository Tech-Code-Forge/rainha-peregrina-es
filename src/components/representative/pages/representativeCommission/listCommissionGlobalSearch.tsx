...
import { Eye, PlaneTakeoff, X } from 'lucide-react'
import Image from 'next/image'
import router from 'next/router'
import { twMerge } from 'tailwind-merge'
import { MonthListProps } from './ListCommission'

interface ListCommissionGlobalSearchProps {
  filteredRequests: MonthListProps[]
}

export default function ListCommissionGlobalSearch({
  filteredRequests,
}: ListCommissionGlobalSearchProps) {
  return (
    <>
