...
export const countries: readonly CountryType[] = [
  ...
  { code: 'CD', label: 'Congo (Kinshasa)', phone: '243' },
  { code: 'CF', label: 'República Centro-Africana', phone: '236' },
  { code: 'CG', label: 'Congo (Brazzaville)', phone: '242' },
  ...
  { code: 'FK', label: 'Ilhas Malvinas', phone: '500' },
  { code: 'FM', label: 'Micronésia', phone: '691' },
  ...
  { code: 'GS', label: 'Geórgia do Sul e Ilhas Sandwich do Sul', phone: '500' },
  { code: 'GT', label: 'Guatemala', phone: '502' },
  { code: 'GU', label: 'Guam', phone: '1-671' },
  { code: 'GW', label: 'Guiné-Bissau', phone: '245' },
  { code: 'GY', label: 'Guiana', phone: '592' },
  { code: 'HK', label: 'Hong Kong, RAE da China', phone: '852' },
  ...
  { code: 'KP', label: 'Coreia do Norte', phone: '850' },
  { code: 'KR', label: 'Coreia do Sul', phone: '82' },
  ...
  { code: 'MD', label: 'Moldávia', phone: '373' },
  { code: 'ME', label: 'Montenegro', phone: '382' },
  { code: 'MF', label: 'São Martinho', phone: '590' },
  { code: 'MG', label: 'Madagascar', phone: '261' },
  { code: 'MH', label: 'Ilhas Marshall', phone: '692' },
  { code: 'MK', label: 'Macedônia', phone: '389' },
  { code: 'ML', label: 'Mali', phone: '223' },
  { code: 'MM', label: 'Mianmar', phone: '95' },
  { code: 'MN', label: 'Mongólia', phone: '976' },
  { code: 'MO', label: 'Macau, RAE da China', phone: '853' },
  ...
  { code: 'SX', label: 'São Martinho', phone: '1-721' },
  ...
  { code: 'TZ', label: 'Tanzânia', phone: '255' },
